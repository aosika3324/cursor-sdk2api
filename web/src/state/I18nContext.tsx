...
export const COPY = {
  en: {
    ...
    navLogs: "Logs",
    navLogsMeta: "Live log stream and request activity",
    ...
    editModal: {
      ...
      note: "Note",
      priority: "Priority",
      priorityHint: "0-1000, lower is preferred.",
      disabled: "Disabled",
      profile: "Default runtime",
      profileSdk: "SDK",
      profileSand: "Sand",
      profileSandOff: "Sand is available after Grok Bot access is granted.",
      proxyHeading: "Proxy",
      proxyUrl: "Proxy URL",
      proxyUrlHint: "http, https, or socks5. Leave empty to clear.",
      proxyUser: "Username",
      proxyPassword: "Password",
      proxySecretHint: "Stored credentials are never returned. Re-enter to change them.",
      proxyCredsSet: "Credentials are set. Leave blank to keep them.",
      save: "Save",
      saving: "Saving",
      cancel: "Cancel",
      saveError: "Could not save your changes. Nothing was closed.",
      confirmRemoveTitle: "Remove account",
      confirmRemoveBody: "Remove this account? This cannot be undone.",
    ...
    logs: {
      ...
      activityHint: "Live per-request outcomes across all credentials.",
      rpm: "RPM",
      statusFilter: "Status code",
      statusFilterPlaceholder: "e.g. 200 or 4",
      credentialFilter: "Credential ID",
      credentialFilterPlaceholder: "Filter by credential",
      capacity: "Capacity",
      refresh: "Refresh",
      ...
      recordCount: "{n} records on this page",
      colAccount: "Account",
      colTime: "Time",
      ...
      colSelect: "Select",
      noActivity: "No request activity yet.",
      streamTitle: "Live log stream",
      streamHint: "Recent entries replay first, then live output.",
      level: "Level",
      levelAll: "All levels",
      levelInfo: "Info",
      levelWarn: "Warn",
      ...
      resume: "Resume",
      clear: "Clear",
      noLogs: "Waiting for log output…",
    },
    login: {
      title: "Console sign in",
      subtitle: "Enter the console access key to manage this gateway.",
      accessKey: "Access key",
      hint: "The access key configured for this managed deployment.",
      placeholder: "Access key",
      submit: "Sign in",
      errorTitle: "Sign in failed",
      invalid: "That access key is not valid.",
  ...
  zh: {
    ...
    editModal: {
      ...
      note: "备注",
      priority: "优先级",
      priorityHint: "0-1000，越小越优先。",
      disabled: "禁用",
      profile: "默认运行时",
      profileSdk: "SDK",
      profileSand: "Sand",
      profileSandOff: "开通 Grok Bot 权限后方可选择 Sand。",
      proxyHeading: "代理",
      proxyUrl: "代理地址",
      proxyUrlHint: "http / https / socks5，留空则清除。",
      proxyUser: "用户名",
      proxyPassword: "密码",
      proxySecretHint: "已保存的凭据不会回传。如需修改请重新填写。",
      proxyCredsSet: "凭据已设置。留空则保持不变。",
      save: "保存",
      saving: "保存中",
      cancel: "取消",
      saveError: "保存失败，未做任何关闭。",
      confirmRemoveTitle: "移除账号",
      confirmRemoveBody: "确认移除该账号？此操作不可撤销。",
      confirmRemove: "移除",
    },
    quotaDetail: {
      title: "额度",
    ...
    logs: {
      ...
      kicker: "实时流",
      activityTitle: "请求活动",
      activityHint: "所有凭证的逐请求结果实时汇总。",
      rpm: "每分钟请求",
      statusFilter: "状态码",
      statusFilterPlaceholder: "如 200 或 4",
      credentialFilter: "凭证 ID",
      credentialFilterPlaceholder: "按凭证过滤",
      capacity: "容量",
      refresh: "刷新",
      clearFilters: "清除筛选",
      exportSelected: "导出所选",
